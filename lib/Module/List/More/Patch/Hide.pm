package Module::List::More::Patch::Hide;
...
1;
# ABSTRACT: Hide some modules from Module::List::More
...
works if the application uses L<Module::List::More>'s C<list_modules()> to check
the availability of modules.
...
L<Module::List::Patch::Hide>, L<Module::List::Wildcard::Patch::Hide>,
